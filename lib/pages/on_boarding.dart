...
class _OnboardingScreenState extends State<OnboardingScreen> {
  ...
  final List<Widget> _onboardingPages = [
    const OnboardingPage(
      ...
      subtitle: "Instant Solutions for Health Machines",
    ),
    const OnboardingPage(
      title: "Track Your Device Health",
      subtitle: "Log device health, usage time, and history",
    ),
    const OnboardingPage(
      title: "Stay Informed",
      subtitle: "Receive insights and recommendations for better Machine management.",
    ),
  ];
